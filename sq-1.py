...
print('Sq-1 model - train only added layers for CIFAR10:')
...
def initialize_model(num_classes, feature_extract, use_pretrained=True):
    ...
    model_ft.classifier[1] = nn.Conv2d(512, num_parameters_conv10, kernel_size=(1,1), stride=(1,1))
    model_ft.num_classes = num_parameters_conv10
    input_size = 224
    return model_ft, input_size

model_ft, input_size = initialize_model(num_parameters_conv10, feature_extract, use_pretrained=True)
model_ft = nn.Sequential(model_ft, 
                        nn.Linear(num_parameters_conv10,mid_layer), 
                        nn.Dropout(p=dr_1),
...
print("")
print(" ****** Sq-1 Architecture for CIFAR10 ******")
print(model_ft)
